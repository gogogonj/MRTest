...
class Tools extends Configured implements Tool {
	...
	public int run(String[] arg0) throws Exception {
		...
		MultipleOutputs.addNamedOutput(job, "AA", TextOutputFormat.class,
				NullWritable.class, Text.class);
		MultipleOutputs.addNamedOutput(job, "BB", TextOutputFormat.class,
				NullWritable.class, Text.class);
		MultipleOutputs.addNamedOutput(job, "CC", TextOutputFormat.class,
				NullWritable.class, Text.class);
